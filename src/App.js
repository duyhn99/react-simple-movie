    ...
    <Fragment>
      ...
      <section className="banner h-[500px] page-container mb-20">
        <div className="w-full h-full rounded-lg relative">
          ...
          <img src="https://genk.mediacdn.vn/2019/4/25/anh-1-15561604267541182022512.jpg" alt="" className="w-full h-full object-cover rounded-lg" />
          <div className="absolute left-5 bottom-5 w-full text-white">
            <h2 className="font-bold text-3xl mb-5">Avengers: Endgame</h2>
            <div className="flex items-center gap-x-3 mb-8">
              <span className="py-4 border border-white rounded-md">Adventure</span>
              <span className="py-4 border border-white rounded-md">Adventure</span>
              <span className="py-4 border border-white rounded-md">Adventure</span>
            </div>
      ...
      <section className="movie-layout page-container pb-20">
        ...
        <div className="movie-list grid grid-cols-4 gap-10">
          <div className="movie-card rounded-lg p-3 bg-slate-800 text-white">
            <img src="https://genk.mediacdn.vn/2019/4/25/anh-1-15561604267541182022512.jpg" alt="" className="w-full h-[250px] object-cover rounded-lg mb-5" />
